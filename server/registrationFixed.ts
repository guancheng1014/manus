...
/**
 * Manus.im 自动注册核心逻辑类 - 改进版
 * 包含正确的代理配置和异步初始化
 */
export class ManusRegisterFixed {
  ...
  private httpAgent: HttpProxyAgent<string> | undefined;
  ...
  private async fetchProxyAsync(): Promise<void> {
    try {
